...
export const CardSelectionModal: React.FC<CardSelectionModalProps> = ({ isOpen, cards, onSelectCard }) => {
    ...
    <div className="fixed inset-0 bg-gray-900/95 z-50 p-4 overflow-y-auto">
      <div className="flex flex-col items-center justify-start sm:justify-center min-h-full py-4">
        <div className="text-center mb-8">
          <h1 className="text-3xl sm:text-4xl text-shadow-hard text-yellow-300 mb-2 animate-pulse">{t('card_selection_title')}</h1>
          <p className="text-sm text-gray-400 max-w-xl mx-auto">{t('card_selection_desc')}</p>
        </div>
